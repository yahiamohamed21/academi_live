...
export default function HelpPage() {
  return (
    <div className="max-w-[1200px] mx-auto p-4 md:p-8 animate-in fade-in duration-500">
      ...
      {/* Header */}
      <div className="text-right mb-12 mt-4 flex flex-col items-start">
        <h1 className="text-3xl font-extrabold text-[#001c56] flex items-center justify-start gap-3 mb-2 flex-row-reverse">
